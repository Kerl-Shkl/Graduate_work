...
\fancypagestyle{apppages}{%
  \fancyhf{}
  \renewcommand{\headrulewidth}{0pt}
  \fancyhead[LE,RO]{Продолжение приложения \thechapter}
  \cfoot{\small \thepage}
}

\fancypagestyle{apppages_end}{%
  \fancyhf{}
  \renewcommand{\headrulewidth}{0pt}
  \fancyhead[LE,RO]{Окончание приложения \thechapter}
  \cfoot{\small \thepage}
}
%-----------------------------------
...
\newcommand{\StdChapter}[1]{
      ...
      \stepcounter{chapter}
      %\chapter*{\thechapter. #1}
      \textbf{\thechapter \ #1} \vspace{4mm} \par
...
\newcommand{\StdAppendixx}[2]{
  ...
  #2 %
  \end{center} %
  \addcontentsline{toc}{chapter}{Приложение \Alph{chapter}. #2} %
}
%------------ listings --------------------
\usepackage{listings}
\usepackage{xcolor}
...
\DeclareTotalCounter{appendixCounter}
%------------------------------------------
...
\makeatother
\AtBeginDocument{\renewcommand\bibname{Список литературы}}
%------------------------------------------
